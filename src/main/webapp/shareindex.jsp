...
<div class="b-wrap " style=" margin-top: 75px;">
    <c:forEach items="${type2}" var="item2" varStatus="status">
        <div class="page-content space-between">
            ...
            <div class="right-side scroll" style="width: 265px;">
                <div class="rank-module">
                    <div class="rank-tabs-bar">
                        <label>文章</label>
                    </div>
                    <ul class="rank-list">
                        <c:if test="${type1!=null}">
                            <c:forEach items="${type1[status.index]}" var="item" >
                                <li class="item">
